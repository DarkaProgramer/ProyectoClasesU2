...
var TaskService = function () {
    ...
    var TaskService = _classThis = /** @class */ (function () {
        ...
        TaskService_1.prototype.getTasks = function () {
            return this.tasks;
        };
        TaskService_1.prototype.getTaskById = function (id) {
        ...
        TaskService_1.prototype.insert = function (task) {
            var newTask = __assign({ id: Date.now() }, task);
            this.tasks.push(newTask);
            return newTask;
        };
        TaskService_1.prototype.update = function (id, taskUpdate) {
            var task = this.getTaskById(id);
            Object.assign(task, taskUpdate);
            return task;
        };
        TaskService_1.prototype.delete = function (id) {
            var index = this.tasks.findIndex(function (t) { return t.id === id; });
            if (index === -1) {
                throw new common_1.HttpException('No se puede eliminar la tarea', common_1.HttpStatus.NOT_FOUND);
            }
